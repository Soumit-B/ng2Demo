...
export var BillToCashRootComponent = (function () {
    function BillToCashRootComponent(viewContainerRef, componentsHelper, riExchange, _authService, _router, _ls, _componentInteractionService, _zone, _errorService) {
    ...
    BillToCashRootComponent.prototype.ngOnInit = function () {
    ...
    BillToCashRootComponent.prototype.ngAfterViewInit = function () {
    };
    BillToCashRootComponent.prototype.ngOnDestroy = function () {
    ...
    BillToCashRootComponent.propDecorators = {
        'errorModal': [{ type: ViewChild, args: ['errorModal',] },],
    };
    return BillToCashRootComponent;
}());
