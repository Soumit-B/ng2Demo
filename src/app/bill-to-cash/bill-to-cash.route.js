...
var routes = [
    {
        path: '', component: BillToCashRootComponent, children: [
            ...
            { path: 'apigeneration', component: ApiGenerationMaintenanceComponent, canDeactivate: [RouteAwayGuardService] },
            ...
            { path: 'postInvoiceManagement/creditAndReInvoiceMaintenance', component: CreditAndReInvoiceMaintenanceComponent },
...
export var BillToCashRouteDefinitions = RouterModule.forChild(routes);
