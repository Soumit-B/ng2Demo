...
export var ContractCommenceDateMaintenanceComponent = (function () {
    function ContractCommenceDateMaintenanceComponent(zone, fb, store, serviceConstants, httpService, authService, errorService, translate, localeTranslateService, titleService, router, route, utils, location) {
        var _this = this;
        this.zone = zone;
        this.fb = fb;
        this.store = store;
    ...
    ContractCommenceDateMaintenanceComponent.prototype.ngOnInit = function () {
        var _this = this;
    ...
    ContractCommenceDateMaintenanceComponent.prototype.ngOnDestroy = function () {
    ...
    ContractCommenceDateMaintenanceComponent.prototype.getContractData = function () {
        var _this = this;
    ...
    ContractCommenceDateMaintenanceComponent.prototype.getStatus = function (contractNumber) {
        var _this = this;
    ...
    ContractCommenceDateMaintenanceComponent.prototype.fetchTranslationContent = function () {
        var _this = this;
    ...
    ContractCommenceDateMaintenanceComponent.prototype.getTranslatedValue = function (key, params) {
        if (params) {
    ...
    ContractCommenceDateMaintenanceComponent.prototype.modalHidden = function () {
        this.fetchTranslationContent();
    };
    ContractCommenceDateMaintenanceComponent.prototype.onContractDataReceived = function (data) {
    };
    ContractCommenceDateMaintenanceComponent.prototype.lookUpRecord = function (data, maxresults) {
    ...
    ContractCommenceDateMaintenanceComponent.prototype.fetchOtherData = function () {
        var _this = this;
        var data = [{
                'table': 'Account',
    ...
    ContractCommenceDateMaintenanceComponent.prototype.fetchContractData = function (functionName, params) {
        this.queryContract = new URLSearchParams();
    ...
    ContractCommenceDateMaintenanceComponent.prototype.fetchContractCommenceData = function (functionName, params) {
        this.queryContract = new URLSearchParams();
        this.queryContract.set(this.serviceConstants.BusinessCode, this.utils.getBusinessCode());
        this.queryContract.set(this.serviceConstants.CountryCode, this.utils.getCountryCode());
        if (functionName !== '') {
    ...
    ContractCommenceDateMaintenanceComponent.prototype.fetchAccountData = function () {
        var _this = this;
    ...
    ContractCommenceDateMaintenanceComponent.prototype.postContractCommenceData = function (functionName, params) {
        var formdata = {};
        this.queryContract = new URLSearchParams();
        this.queryContract.set(this.serviceConstants.BusinessCode, this.utils.getBusinessCode());
        this.queryContract.set(this.serviceConstants.CountryCode, this.utils.getCountryCode());
    ...
    ContractCommenceDateMaintenanceComponent.prototype.commenceDateSelectedValue = function (value) {
        var _this = this;
    ...
    ContractCommenceDateMaintenanceComponent.prototype.setAnnivDate = function (commenceDateDisplay) {
    ...
    ContractCommenceDateMaintenanceComponent.prototype.annivDateSelectedValue = function (value) {
        if (value && value.value) {
            this.annivDateDisplay = value.value;
        }
    };
    ContractCommenceDateMaintenanceComponent.prototype.onSubmit = function (data, valid, event) {
        event.preventDefault();
        this.promptModal.show();
    };
    ContractCommenceDateMaintenanceComponent.prototype.promptSave = function (event) {
        var _this = this;
    ...
    ContractCommenceDateMaintenanceComponent.prototype.onCancelClick = function (event) {
        if (this.parentQueryParams && this.parentQueryParams['parentRoute'] !== '') {
            this.location.back();
        }
    };
    ContractCommenceDateMaintenanceComponent.prototype.onContractNumberBlur = function (event) {
    ...
    ContractCommenceDateMaintenanceComponent.decorators = [
        { type: Component, args: [{
    ...
    ContractCommenceDateMaintenanceComponent.ctorParameters = [
        { type: NgZone, },
        { type: FormBuilder, },
        { type: Store, },
    ...
    ContractCommenceDateMaintenanceComponent.propDecorators = {
        'errorModal': [{ type: ViewChild, args: ['errorModal',] },],
        'messageModal': [{ type: ViewChild, args: ['messageModal',] },],
        'promptModal': [{ type: ViewChild, args: ['promptModal',] },],
    };
    return ContractCommenceDateMaintenanceComponent;
}());
