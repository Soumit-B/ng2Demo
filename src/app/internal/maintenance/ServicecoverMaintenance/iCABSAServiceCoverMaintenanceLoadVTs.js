...
export var ServiceCoverMaintenanceLoadVTs = (function () {
    function ServiceCoverMaintenanceLoadVTs(parent) {
        this.parent = parent;
        this.context = parent;
    }
    ServiceCoverMaintenanceLoadVTs.prototype.LoadVirtualTables = function () {
        ...
        this.context.riMaintenance.AddVirtualTableKeyCS('BusinessCode', MntConst.eTypeCode);
        this.context.riMaintenance.AddVirtualTableKey('ServicMntConst.eTypeCode', MntConst.eTypeCode, MntConst.eVirtualKeyStateNormal, '', '', '', 'Virtual');
        ...
        if (this.context.pageParams.vbEnableEntitlement && this.context.pageParams.CurrentContractType === 'C') {
            ...
            this.context.riMaintenance.AddVirtualTableKey('EntitlementInvoicMntConst.eTypeCode', MntConst.eTypeCode, MntConst.eVirtualKeyStateNormal, '', '', '', 'Virtual');
        ...
        this.context.riMaintenance.AddVirtualTableKeyCS('BusinessCode', MntConst.eTypeCode);
        this.context.riMaintenance.AddVirtualTableKey('RMMCateg||yCode', MntConst.eTypeCode, MntConst.eVirtualKeyStateNormal, '', '', '', 'Virtual');
        this.context.riMaintenance.AddVirtualTableKey('LanguageCode', MntConst.eTypeCode, MntConst.eVirtualKeyStateNormal, '=', this.context.riExchange.LanguageCode(), '', 'Virtual');
        this.context.riMaintenance.AddVirtualTableField('RMMCateg||yDesc', MntConst.eTypeText, MntConst.eVirtualKeyStateNormal, 'Virtual');
        this.context.riMaintenance.AddVirtualTableCommit(this.context, function (data) {
    ...
    return ServiceCoverMaintenanceLoadVTs;
}());
