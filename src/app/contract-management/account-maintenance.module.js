...
export var AccountMaintenanceRootComponent = (function () {
    function AccountMaintenanceRootComponent(viewContainerRef, componentsHelper) {
        componentsHelper.setRootViewContainerRef(viewContainerRef);
    }
    AccountMaintenanceRootComponent.decorators = [
        { type: Component, args: [{
                    template: "<router-outlet></router-outlet>\n    "
                },] },
    ];
    AccountMaintenanceRootComponent.ctorParameters = [
        { type: ViewContainerRef, },
        { type: ComponentsHelper, },
    ];
    return AccountMaintenanceRootComponent;
}());
export var AccountMaintenanceModule = (function () {
    function AccountMaintenanceModule() {
    }
    AccountMaintenanceModule.decorators = [
        { type: NgModule, args: [{
                    imports: [
                        HttpModule,
    ...
    AccountMaintenanceModule.ctorParameters = [];
    return AccountMaintenanceModule;
}());
