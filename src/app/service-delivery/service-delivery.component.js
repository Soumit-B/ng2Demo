...
export var ServiceDeliveryRootComponent = (function () {
    function ServiceDeliveryRootComponent(viewContainerRef, componentsHelper, riExchange, _authService, _router, _ls, _componentInteractionService, _zone, _errorService) {
    ...
    ServiceDeliveryRootComponent.prototype.ngOnInit = function () {
    ...
    ServiceDeliveryRootComponent.prototype.ngAfterViewInit = function () {
    };
    ServiceDeliveryRootComponent.prototype.ngOnDestroy = function () {
    ...
    ServiceDeliveryRootComponent.propDecorators = {
        'errorModal': [{ type: ViewChild, args: ['errorModal',] },],
    };
    return ServiceDeliveryRootComponent;
}());
