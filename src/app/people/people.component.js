...
export var PeopleRootComponent = (function () {
    function PeopleRootComponent(viewContainerRef, componentsHelper, riExchange, _authService, _router, _ls, _componentInteractionService, _zone, _errorService) {
    ...
    PeopleRootComponent.prototype.ngOnInit = function () {
    ...
    PeopleRootComponent.prototype.ngAfterViewInit = function () {
    };
    PeopleRootComponent.prototype.ngOnDestroy = function () {
    ...
    PeopleRootComponent.propDecorators = {
        'errorModal': [{ type: ViewChild, args: ['errorModal',] },],
    };
    return PeopleRootComponent;
}());
