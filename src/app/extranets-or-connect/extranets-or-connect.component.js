...
export var ExtranetsOrConnectRootComponent = (function () {
    function ExtranetsOrConnectRootComponent(viewContainerRef, componentsHelper, riExchange, _authService, _router, _ls, _componentInteractionService, _zone, _errorService) {
    ...
    ExtranetsOrConnectRootComponent.prototype.ngOnInit = function () {
    ...
    ExtranetsOrConnectRootComponent.prototype.ngAfterViewInit = function () {
    };
    ExtranetsOrConnectRootComponent.prototype.ngOnDestroy = function () {
    ...
    ExtranetsOrConnectRootComponent.propDecorators = {
        'errorModal': [{ type: ViewChild, args: ['errorModal',] },],
    };
    return ExtranetsOrConnectRootComponent;
}());
