...
export var ProspectToContractRootComponent = (function () {
    function ProspectToContractRootComponent(viewContainerRef, componentsHelper, riExchange, _authService, _router, _ls, _componentInteractionService, _zone, _errorService) {
    ...
    ProspectToContractRootComponent.prototype.ngOnInit = function () {
    ...
    ProspectToContractRootComponent.prototype.ngAfterViewInit = function () {
    };
    ProspectToContractRootComponent.prototype.ngOnDestroy = function () {
    ...
    ProspectToContractRootComponent.propDecorators = {
        'errorModal': [{ type: ViewChild, args: ['errorModal',] },],
    };
    return ProspectToContractRootComponent;
}());
