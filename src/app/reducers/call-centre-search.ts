...
interface CallCenterSearch {
    ...
    tabsTranslation: Object;
    printInvoice: Array<any>;
    emailInvoice: Array<any>;
    allowAjaxOnDateChange: boolean;
    gridToBuild: Array<any>;
    gridToClear: Array<any>;
    subject: any;
    pagination: Object;
    refresh: Object;
    index: Object;
...
const initialState: CallCenterSearch = {
    data: {
...
export function storeFunction(state: any = initialState, action: Action): any {
    switch (action.type) {
        ...
        state = Object.assign({}, state, {
            action: CallCenterActionTypes.DISPLAY_MESSAGE,
...
export const callcentresearch: ActionReducer<any> = storeFunction;
