...
interface AccountMaintenance {
    data: Object;
    account: Object;
    mode: Object;
    syschars: Object;
    processedSysChar: Object;
    virtualTableData: Object;
    params: Object;
    otherParams: Object;
...
const initialState: AccountMaintenance = {
    data: {},
    account: {},
    mode: {
        updateMode: false,
...
export const accountMaintenance: ActionReducer<any> = storeFunction;
