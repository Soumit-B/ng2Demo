...
@Directive({
    selector: '[eTypeDecimal1]'
})
export class DecimalType1Directive implements OnInit, OnDestroy {
    ...
    private updateFormControl(value: any, calledFromChange?: boolean): void {
        if (typeof value !== 'undefined' && value !== null && value !== '') {
            ...
            let formattedValue: any = this.globalize.formatDecimalToLocaleFormat(value, 1, calledFromChange);
