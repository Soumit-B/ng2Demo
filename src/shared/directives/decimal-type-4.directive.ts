...
@Directive({
    selector: '[eTypeDecimal4]'
})
export class DecimalType4Directive implements OnInit, OnDestroy {
    ...
    private updateFormControl(value: any, calledFromChange?: boolean): void {
        if (typeof value !== 'undefined' && value !== null && value !== '') {
            ...
            let formattedValue: any = this.globalize.formatDecimalToLocaleFormat(value, 4, calledFromChange);
