...
@Directive({
    selector: '[eTypeDecimal2]'
})
export class DecimalType2Directive implements OnInit, OnDestroy {
    ...
    private updateFormControl(value: any, calledFromChange?: boolean): void {
        if (typeof value !== 'undefined' && value !== null && value !== '') {
            ...
            let formattedValue: any = this.globalize.formatDecimalToLocaleFormat(value, 2, calledFromChange);
