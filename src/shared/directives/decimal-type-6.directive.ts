...
@Directive({
    selector: '[eTypeDecimal6]'
})
export class DecimalType6Directive implements OnInit, OnDestroy {
    ...
    private updateFormControl(value: any, calledFromChange?: boolean): void {
        if (typeof value !== 'undefined' && value !== null && value !== '') {
            ...
            let formattedValue: any = this.globalize.formatDecimalToLocaleFormat(value, 6, calledFromChange);
