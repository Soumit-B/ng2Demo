...
@Directive({
    selector: '[eTypeDecimal5]'
})
export class DecimalType5Directive implements OnInit, OnDestroy {
    ...
    private updateFormControl(value: any, calledFromChange?: boolean): void {
        if (typeof value !== 'undefined' && value !== null && value !== '') {
            ...
            let formattedValue: any = this.globalize.formatDecimalToLocaleFormat(value, 5, calledFromChange);
