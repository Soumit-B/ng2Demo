...
process.env.MULE_LOGIN_API = 'https://api-staging-emea.ri-gateway.com/nextgenui/1.0/api/x/auths/login';
...
process.env.GA_TRACK_CODE = 'UA-93679236-3';
...
process.env.USER_ACCESS_URL = "https://api-staging-emea.ri-gateway.com/nextgenui/1.0/api/x/user/menu";
process.env.USER_CODE_URL = "https://api-staging-emea.ri-gateway.com/nextgenui/1.0/api/x/user/information";
process.env.USER_ACCESS_POSTFIX = 'user/menu';
process.env.USER_CODE_POSTFIX = 'user/information';
process.env.ZIP_SEARCH_URL = "https://api-staging-emea.ri-gateway.com/nextgenui/x/1.0/contract-management/search";
process.env.BASE_URL = 'https://api-staging-emea.ri-gateway.com/nextgenui/1.0/api/x/';
process.env.BASE_URL_EUROPE = 'https://api-staging-emea.ri-gateway.com/nextgenui/1.0/api/x/';
process.env.BASE_URL_AMERICA = 'https://api-staging-na.ri-gateway.com/nextgenui/1.0/api/x/';
process.env.BASE_URL_AUSTRALIA = 'https://api-staging-asia.ri-gateway.com/nextgenui/1.0/api/x/';
process.env.BASE_URL_PACIFIC = 'https://api-staging-asia.ri-gateway.com/nextgenui/1.0/api/x/';
process.env.BASE_URL_ASIA = 'https://api-staging-asia.ri-gateway.com/nextgenui/1.0/api/x/';
process.env.IMAGE_REPO_URL = 'assets/images/';

process.env.INVOICE_HISTORY = 'http://localhost:3030/api/contractInvoiceHistory';
process.env.CONTACT_SEARCH = 'https://api-staging-emea.ri-gateway.com/nextgenui/1.0/api/x/';
...
process.env.FIREBASE_TRANSLATION_URL = 'https://storage.googleapis.com/ri-newui-stg-ac8c7.appspot.com/i18n/';
process.env.FIREBASE_LOCALIZATION_URL = 'https://storage.googleapis.com/ri-newui-next-stg.appspot.com/';
...
process.env.MULE_CLIENT_ID = '49b13f926c15491d9c06acd685bcf858';
process.env.MULE_CLIENT_SECRET = '11b34e0cbd3346db84A189C65061B44F';
