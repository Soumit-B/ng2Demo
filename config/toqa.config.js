...
process.env.MULE_LOGIN_API = 'https://api-test.ri-gateway.com​/nextgenui/1.0/api/x/auths/login';
...
process.env.GA_TRACK_CODE = 'UA-93679236-2';
...
process.env.USER_ACCESS_URL = "https://api-test.ri-gateway.com/nextgenui/1.0/api/x/user/menu";
process.env.USER_CODE_URL = "https://api-test.ri-gateway.com/nextgenui/1.0/api/x/user/information";
process.env.USER_ACCESS_POSTFIX = 'user/menu';
process.env.USER_CODE_POSTFIX = 'user/information';
process.env.ZIP_SEARCH_URL = "https://api-test.ri-gateway.com/nextgenui/x/1.0/contract-management/search";
process.env.BASE_URL_EUROPE = 'https://api-test.ri-gateway.com/nextgenui/1.0/api/x/';
process.env.BASE_URL_AMERICA = 'https://api-test.ri-gateway.com/nextgenui/1.0/api/x/';
process.env.BASE_URL_AUSTRALIA = 'https://api-test.ri-gateway.com/nextgenui/1.0/api/x/';
process.env.BASE_URL_ASIA = 'https://api-test.ri-gateway.com/nextgenui/1.0/api/x/';
...
process.env.CONTACT_SEARCH = 'https://api-test.ri-gateway.com/nextgenui/1.0/api/x/';
...
process.env.FIREBASE_TRANSLATION_URL = 'https://storage.googleapis.com/ri-newui-sit.appspot.com/i18n/';
process.env.FIREBASE_LOCALIZATION_URL = 'https://storage.googleapis.com/ri-newui-next-sit.appspot.com/';
/*process.env.FIREBASE_CONFIG = JSON.stringify({
    apiKey: "AIzaSyASNSqmBh3v0p87KKC8pKcVSNL7bwY4H1M",
    authDomain: "ri-newui-sit.firebaseapp.com",
    databaseURL: "https://ri-newui-sit.firebaseio.com",
    projectId: "ri-newui-sit",
    storageBucket: "ri-newui-sit.appspot.com",
    messagingSenderId: "639550012333"
});*/
...
function appConfig() {
    ...
    var apiURL = {
        ...
        urls: {
            ...
            'process.env.FIREBASE_TRANSLATION_URL': process.env.FIREBASE_TRANSLATION_URL,
